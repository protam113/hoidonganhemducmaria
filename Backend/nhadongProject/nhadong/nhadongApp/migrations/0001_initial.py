    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('action', models.CharField(choices=[('create', 'Thêm'), ('edit', 'Sửa'), ('delete', 'Xóa')], max_length=10)),
                ('status', models.CharField(choices=[('approve', 'Được duyệt'), ('reject', 'Bị từ chối'), ('pending', 'Đang chờ')], default='pending', max_length=10)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
            ],
            options={
                'abstract': False,
